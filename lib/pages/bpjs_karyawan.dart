...
class BPJSKaryawanPage extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xFF1572E8).withOpacity(0.1), // Background color
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white.withOpacity(0.2), // Background for the icon box
              borderRadius: BorderRadius.circular(8),
            ),
            child: const Icon(Icons.file_upload, size: 30, color: Colors.white), // Upload icon
          ),
          Expanded(
            child: Text(
              title,
